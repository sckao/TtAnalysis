...
class TtSemiEventSolution {
   public:
    ...
    bool recoW( int type, std::vector<pat::Jet> wjets, std::vector<iReco>& wCandidate, HTOP9* histo9 );
    bool recoW( int type, std::vector<const reco::Candidate*> lepton, edm::Handle<std::vector<pat::MET> > met,
                std::vector<iReco>& wCandidate, HTOP9* histo9 );
