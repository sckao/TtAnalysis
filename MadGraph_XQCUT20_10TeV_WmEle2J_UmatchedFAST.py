...
process.load("Configuration.GenProduction.MadGraph_XQCUT20_10TeV_WmEle2J_Umatched_cff")
...
process.o1 = cms.OutputModule(
    "PoolOutputModule",
    fileName = cms.untracked.string("/data/top/sckao/WmEle2J/WmEle2J_Inclusive_Fast.root"),
